...
User can upload the csv files from their own system. the Application shows the data of CSV file in Table format and where user can also perform some operations.
